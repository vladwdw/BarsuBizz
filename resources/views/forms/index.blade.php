        ...
        <div class="row" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-md-6 mt-4 mt-md-0">
            <div class="icon-box">
              ...
              <h4><a href="{{route('form2')}}">Конкурсный отбор НИР в рамках системы внутренних грантов БарГУ</a></h4>
              <p>Типо текст</p>
            </div>
          </div>
          <div class="col-md-6 mt-4 mt-md-0">
          ...
          <div class="col-md-6 mt-4 mt-md-0">
            <div class="icon-box">
              ...
              <h4><a href="{{route('form5')}}">Заявка на получение гранта</a></h4>
              <p>Типо текст</p>
            </div>
          </div>
          <div class="col-md-6 mt-4 mt-md-0">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="member" data-aos="fade-up" data-aos-delay="100">
              <div class="pic"><img src="assets/img/kalko.png" class="img-fluid" alt=""></div>
              <div class="member-info">
                <h4>Калько Алексей Игоревич</h4>
                <span>СЕО, Продакшн</span>
                <div class="social">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="member">
              <div class="pic"><img src="assets/img/shah.jpg" class="img-fluid" alt=""></div>
              <div class="member-info">
                <h4>Шах Александр Васильевич</h4>
